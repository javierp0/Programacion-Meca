...
//(main) es la parte mas esencial para iniciar un programa ya que sirve como punto de partida para la ejecucion.
{
    ...
    if (PRE > 1500) // En este caso "if" pone una condicion de que "PRE" sea mayor a 1500.
    {
        ...
        printf("\nNuevo precio: %7.2f",NPR); // Este printf muestra el vslor de la variable NPR con un salto de linea (solo se imprimira los primeros 7 numeros enterosy los primeros 2 decimales debido a: "%7.2f").
    }
}
